...
def load(verbosity=1):
    ...
    if not loaded:
        ...
        Callback = import_module("pymoo.core.callback", hint="pip install pymoo").Callback
        ...
        LatinHypercubeSampling = import_module("pymoo.operators.sampling.lhs", hint="pip install pymoo").LatinHypercubeSampling
        SBX = import_module("pymoo.operators.crossover.sbx", hint="pip install pymoo").SBX
        PM = import_module("pymoo.operators.mutation.pm", hint="pip install pymoo").PM
        GA = import_module("pymoo.algorithms.soo.nonconvex.ga", hint="pip install pymoo").GA
        NSGA2 = import_module("pymoo.algorithms.moo.nsga2", hint="pip install pymoo").NSGA2
        PSO = import_module("pymoo.algorithms.soo.nonconvex.pso", hint="pip install pymoo").PSO
        MixedVariableGA = import_module("pymoo.core.mixed", hint="pip install pymoo").MixedVariableGA
